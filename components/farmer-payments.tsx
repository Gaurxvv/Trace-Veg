  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-green-50 to-green-100">
      ...
      <main className="container mx-auto px-4 py-8">
        <h1 className="text-4xl font-bold text-green-800 mb-8 text-center">Direct Farmer Payments</h1>
        
        <section className="mb-12">
          <p className="text-lg text-gray-700 mb-4">
            VegeTrace ensures fair compensation for farmers through our blockchain-based direct payment system. 
            This transparent process eliminates intermediaries and guarantees timely payments for your produce.
          </p>
        </section>
        ...
        <section className="grid md:grid-cols-2 gap-8 mb-12">
          <div className="bg-white rounded-lg shadow-md p-8">
            ...
            <form onSubmit={handlePayment}>
              <div className="mb-4">
                <label htmlFor="amount" className="block text-sm font-medium text-gray-700 mb-1">Payment Amount (₹)</label>
                <Input
                  type="number"
                  id="amount"
                  value={amount}
          ...
          <div className="bg-white rounded-lg shadow-md p-8">
            ...
            <div className="space-y-4">
              <div className="flex items-center justify-between">
                <span className="text-gray-600">Total Payments This Month:</span>
        ...
        <section className="grid md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
          <div className="bg-white rounded-lg shadow-md p-6">
            ...
            <p className="text-gray-700">
              Receive payments directly to your account within minutes of transaction confirmation.
            </p>
          </div>
          <div className="bg-white rounded-lg shadow-md p-6">
            ...
            <p className="text-gray-700">
              Choose from various payment methods including bank transfer and mobile money.
            </p>
          </div>
          <div className="bg-white rounded-lg shadow-md p-6">
            ...
            <p className="text-gray-700">
              Access detailed reports of all your transactions for better financial management.
            </p>
          </div>
          <div className="bg-white rounded-lg shadow-md p-6">
            ...
            <p className="text-gray-700">
              Benefit from fair, market-driven prices for your produce, updated in real-time.
            </p>
          </div>
        </section>
      </main>
