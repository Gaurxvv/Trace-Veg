      ...
      <main className="container mx-auto px-4 py-8">
        ...
        <section className="mb-12">
          <p className="text-lg text-gray-700 mb-4">
            With VegeTrace, you can now trace the journey of your vegetables
            from farm to table. Know exactly where your food comes from, how it
            was grown, and support sustainable farming practices.
          </p>
        </section>
        ...
        <section className="grid md:grid-cols-2 gap-8 mb-12">
          <div className="bg-white rounded-lg shadow-md p-6">
            ...
            <p className="text-gray-700">
              Access detailed information about the origin, farming practices,
              and journey of your vegetables.
            </p>
          </div>
          <div className="bg-white rounded-lg shadow-md p-6">
            ...
            <p className="text-gray-700">
              Verify the freshness and quality of your produce with
        ...
        <section className="bg-white rounded-lg shadow-md p-8 mb-12">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="text-center">
              ...
              <p className="text-gray-700">
                Don&apos;t forget to scan the VegeTrace QR code on vegetable
                packaging in participating stores.
              </p>
            </div>
            <div className="text-center">
              ...
              <p className="text-gray-700">
                Use your smartphone to scan the QR code and access the
                vegetable&apos;s journey.
              </p>
            </div>
            <div className="text-center">
        ...
        <section className="bg-green-600 text-white rounded-lg shadow-md p-8 mb-12">
          <h2 className="text-3xl font-semibold mb-6 text-center">
            Ready to Trace Your Veggies?
          </h2>
          <p className="text-center mb-6">
            Download our app to start tracing your vegetables and supporting
